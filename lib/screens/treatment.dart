...
class TratamientosPageState extends State<TratamientosPage> {
  ...
  Future<void> _downloadReport() async {
    try {
      final bytes = await TratamientoService.downloadTratamientoReport(context);
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Reporte guardado en: $filePath')));
    } catch (e) {
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No se encontraron tratamientos'));
          }
